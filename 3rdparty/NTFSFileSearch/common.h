...
typedef enum NTFS_FILTER_OPERATOR
{
  FF_OPERATOR_EQUAL,
  FF_OPERATOR_NOT_EQUAL,
  FF_OPERATOR_GREATER_THAN,
  FF_OPERATOR_GREATER_THAN_OR_EQ,
  FF_OPERATOR_LESS_THAN,
  FF_OPERATOR_LESS_THAN_OR_EQ,
};
